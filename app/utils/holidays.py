    ...
    def _get_holiday_object(
        ...
        try:
            ...
            if hasattr(holidays, country_upper):
                ...
                logger.warning(f"Country '{country_upper}' not supported by holidays library")
                return None
    ...
    def get_supported_countries(cls) -> Set[str]:
        ...
        for attr_name in dir(holidays):
            ...
            if (isinstance(attr, type) and 
                issubclass(attr, holidays.HolidayBase) and 
                attr != holidays.HolidayBase):
